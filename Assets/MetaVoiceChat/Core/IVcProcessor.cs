...
{
    public interface IVcProcessor
    {
        /// <summary>
        /// Processes a frame of audio data.
        /// </summary>
        /// <param name="frame">PCM audio data, there is no ownership transfer contract; the data should be copied immediately if needed</param>
