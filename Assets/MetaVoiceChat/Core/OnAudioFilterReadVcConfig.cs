...
namespace MetaVoiceChat.Core
{
    ...
    public class OnAudioFilterReadVcConfig : ScriptableObject
    {
        ...
        [Tooltip("Enables warning messages for audio playback.")]
        ...
        [Range(0, 10)] public int resamplerQuality = 4;
        ...
        [Range(10, 100)]
        [SerializeField] private int resamplerBufferMs = 10;

        [Header("NetEq Settings")]
        public int maxPacketsInBuffer = 50;
        public uint maxDelayMs = 500;
        public uint minDelayMs = 10;
        public uint additionalDelayMs = 0;
